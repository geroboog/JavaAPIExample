    ...
    <div class="shareMain">
        ...
        <table>
        	<tr>
        		...
        		<td colspan="2">
        		 <input name="phone" id="phone" type="text" class="phoneNum" placeholder="输入手机号码" />
        		</td>
        	</tr>
        	...
        	<tr>
        		...
        		<td colspan="2">
        		 <input name="password" id="password" type="password" class="phoneNum" placeholder="输入密码" />
            	</td>
        	</tr>
        	...
        	<tr>
        		...
        		<td>
        		<input name="vcode" id="vcode" type="text" class="phoneNum" placeholder="输入手机号码" />
        		</td>
        		<td>
        		 <p><a href="javascirpt:void(0);" class="loginBtn" id="getVcode" onclick="return false;">点击获取</a> </p>
        	...
        	<tr>
        		<td colspan="3">
        		<p><a href="javascirpt:void(0);" class="loginBtn" id="submitPhone" onclick="return false;">点击上传</a> </p>
        		</td>
        	</tr>
        </table>
...
$(function(){
	...
	var refereeId = getUrlParam('refereeId');

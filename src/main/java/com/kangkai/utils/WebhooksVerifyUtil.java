...
public class WebhooksVerifyUtil {
	...
	private static String pubKeyPath = "/usr/local/tomcat/webapps/yohoRSM/pingpp_public_key.pem";//"C:/yohoRSM/pingpp_public_key.pem";//
	// private static String eventPath = "D:/res/webhooks_raw_post_data.json";
	...
	public static boolean validate(String signature, String webhooksRawPostData) throws Exception {
		// 该数据请从 request 中获取原始 POST 请求数据, 以下仅作为示例
		// String webhooksRawPostData1 = getStringFromFile(eventPath);
